...
enum eviewitf_mfis_return_code {
...
enum eviewitf_mfis_camera_type {
...
/* End deprecated */
#define EVIEWITF_MFIS_CAMERA_ATTRIBUTES		_IOR(EVIEWITF_MFIS_IOC_MAGIC, 3, struct eviewitf_mfis_camera_attributes*)
#define EVIEWITF_MFIS_BLENDING_ATTRIBUTES	_IOR(EVIEWITF_MFIS_IOC_MAGIC, 4, struct eviewitf_mfis_blending_attributes*)
